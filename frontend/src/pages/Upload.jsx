...
void motion;
import { uploadDocument, getDocuments, deleteDocument, getApiErrorMessage } from '../api/axios';
import { Upload as UploadIcon, FileText, Loader2, CloudUpload, Trash2 } from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)', marginTop: 2 }}>Indexed and ready for analysis</div>
            </div>
                    ...
                    {uploading ? (
                        ...
                        <motion.div key="idle" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                            ...
                            <div style={{ fontWeight: 700, fontSize: '1.1rem', color: 'var(--text-primary)', marginBottom: 8, fontFamily: 'Outfit' }}>
                                {isDragActive ? 'Drop your document here' : 'Drag and drop your PDF'}
                            </div>
                            <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginBottom: 20 }}>
                                or click to browse files
                            </div>
                            <div className="badge badge-info" style={{ margin: '0 auto' }}>PDF supported</div>
                        </motion.div>
                    )}
                </AnimatePresence>
            </motion.div>
